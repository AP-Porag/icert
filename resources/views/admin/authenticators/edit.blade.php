                                            ...
                                            <div class="mb-3 col-md-6">
                                                ...
                                                <div class="form-check form-check-inline">
                                                    <input type="radio" id="status_yes" value="{{ \App\Models\Authenticator::STATUS_ACTIVE }}"
                                                           name="status" class="form-check-input" @if($item->status == \App\Models\Authenticator::STATUS_ACTIVE) checked @endif>
                                                ...
                                                <div class="form-check form-check-inline">
                                                    <input type="radio" id="status_no" value="{{ \App\Models\Authenticator::STATUS_SUSPEND }}"
                                                           name="status" class="form-check-input" @if($item->status == \App\Models\Authenticator::STATUS_SUSPEND) checked @endif>
                                                ...
                                                <div class="form-check form-check-inline">
                                                    <input type="radio" id="status_no" value="{{ \App\Models\Authenticator::STATUS_DELETE }}"
                                                           name="status" class="form-check-input" @if($item->status == \App\Models\Authenticator::STATUS_DELETE) checked @endif>
